...
plt.title('Experimento #2 - Utilizando dHash')
...
plt.title('Experimento #2 - Utilizando Inception ResNet V2')
plt.text(23, 45, r'$\mu=15, b=3$')
plt.gca().yaxis.set_major_formatter(PercentFormatter(1))
plt.show()
